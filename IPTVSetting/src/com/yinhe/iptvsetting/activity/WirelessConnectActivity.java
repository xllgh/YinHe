...
public class WirelessConnectActivity extends Activity implements
    ...
    private final String AccessType_Propname = "prop.AccessType";
    ...
    private boolean mInXlSetupWizard = false;
    ...
    private void initData() {
        ...
        // mWifiManager.asyncConnect(this, new WifiServiceHandler()); hqq
    ...
    private void createPasswordInputDialog(final AccessPoint item) {
        ...
        View view = inflater.inflate(R.layout.connect_wifi_dialog, null);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case AsyncChannel.CMD_CHANNEL_HALF_CONNECTED:
                    ...
                    break;
                // case WifiManager.CMD_WPS_COMPLETED: hqq
                // WpsResult result = (WpsResult) msg.obj;
                // if (result == null) break;
                // AlertDialog.Builder dialog = new
                // AlertDialog.Builder(WirelessConnectActivity.this)
    ...
    private void updateAccessPoints() {
        ...
        switch (wifiState) {
                ...
                if (mInXlSetupWizard) {
                    ...
                    for (AccessPoint accessPoint : accessPoints) {
                        ...
                        if (accessPoint.getState() != null) {
                            logD("accessPoint.ssid:" + accessPoint.ssid);
                            logD("我要看看你到底是什么值：" + ""
                                    + accessPoint.getState().ordinal());
                        }
            ...
            case WifiManager.WIFI_STATE_ENABLING:
                /*
                 * getPreferenceScreen().removeAll();d
                 * getPreferenceScreen().addPreference(wifiCheck);//hqq
                 */break;
    ...
    private void updateConnectionState(DetailedState state) {
        ...
        /*
         * for (int i = getPreferenceScreen().getPreferenceCount() - 1; i >= 0;
         * --i) { // Maybe there's a WifiConfigPreference Preference preference
         * = getPreferenceScreen().getPreference(i); if (preference instanceof
         * AccessPoint) { final AccessPoint accessPoint = (AccessPoint)
         * preference; accessPoint.update(mLastInfo, mLastState); } //hqq }
         */

        if (mInXlSetupWizard) {
            // ((WifiSettingsForSetupWizardXL)getActivity()).updateConnectionState(mLastState);//hqq
        }
    }
    ...
    private void changeNextButtonState(boolean connected) {
         ...
         * if (mInXlSetupWizard) { //
         * ((WifiSettingsForSetupWizardXL)getActivity(
         * )).changeNextButtonState(connected); } else if
         * (mEnableNextOnConnection && hasNextButton()) {
    ...
    private void turnOnWifi() {
        ...
        SystemProperties.set(AccessType_Propname, "Wlan");//
