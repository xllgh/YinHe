...
public class PullScrollView extends RelativeLayout {
	...
	//1、填充布局结束，获取刷新视图和内容视图
	@Override
	protected void onFinishInflate() {
		super.onFinishInflate();
		if (getChildCount() > 2) {
			throw new RuntimeException("瀛愬瀛愬彧鑳芥湁涓や釜");
		}
	...
	//6、Called by a parent to request that a child update its values for mScrollX and mScrollY if necessary.
