...
class AccessPoint extends Preference {
    ...
    private void refresh() {
        setTitle(ssid);
        Log.d(TAG, "refresh accesspoint");
        Context context = getContext();
        if (mConfig != null && mConfig.status == WifiConfiguration.Status.DISABLED) {
            Log.d(TAG, "refresh disableReason: " + mConfig.disableReason);
            switch (mConfig.disableReason) {
                ...
                case WifiConfiguration.DISABLED_DNS_FAILURE:
                    ...
                    break;
                case WifiConfiguration.DISABLED_PPPOE_AUTH_FAILURE:
                    setSummary(context.getString(R.string.wifi_disabled_pppoe_auth_failure));
                    break;
