...
public class MyVolumePreference extends SeekBarDialogPreference  implements PreferenceManager.OnActivityStopListener, View.OnKeyListener {

	private static final String TAG = "MyVolumePreference";
	...
	public MyVolumePreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public boolean onKey(View v, int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_VOLUME_MUTE:
            Log.d(TAG, "KeyEvent.KEYCODE_VOLUME_MUTE");
            if (isdown) {
	...
	public class SeekBarVolumizer implements OnSeekBarChangeListener, Runnable {
		...
		private ContentObserver mVolumeObserver = new ContentObserver(mHandler) {
            ...
            public void onChange(boolean selfChange) {
                ...
                if (mSeekBar != null && mAudioManager != null) {
                    int volume = mAudioManager.isStreamMute(mStreamType) ? mAudioManager
		...
		private void initSeekBar(SeekBar seekBar, Uri defaultUri) {
			...
			boolean muted = mAudioManager.isStreamMute(mStreamType);
			mOriginalStreamVolume = muted ? mAudioManager
                    .getLastAudibleStreamVolume(mStreamType) : mAudioManager
		...
		public void run() {
			mAudioManager.setStreamMute(mStreamType, false);
