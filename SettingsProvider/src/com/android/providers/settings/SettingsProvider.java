...
public class SettingsProvider extends ContentProvider {
    ...
    public static final String QB_WAIT_CLASS_NAME = "SettingsProvider";
    public static final String QB_WAIT_ENTRY_NAME = "settings";

    private boolean qb_lock = true;
	...
	if(SystemProperties.get("persist.sys.qb.enable","false").equals("true"))
        {
            ...
            Log.i(TAG, "QbAndroidManager Call getQbState");

            mQbAndroidManager = (QbAndroidManager)getContext().getSystemService(Context.QB_ANDROID_MANAGER_SERVICE);
